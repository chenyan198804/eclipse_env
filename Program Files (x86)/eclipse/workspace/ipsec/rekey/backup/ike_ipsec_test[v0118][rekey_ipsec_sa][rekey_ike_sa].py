...
def gen_ipsec_secret_key(ipsec_nonce_i, ipsec_nonce_r):
...
def gen_create_child__sa_for_rekey_ipsec(ipsec_spi_i, SK_ei, SK_ai):
	global ike_message_id
	...
	return (ipsec_spi_i, ipsec_nonce_i)
...
def gen_create_child_sa_for_rekey_ike(ya, ike_spi_i, ike_spi_r, SK_ai, SK_ei):
	...
	return (ike_spi_i, ike_nonce_i)


ipsec_nonce_i = ike_nonce_i
ipsec_nonce_r = ike_nonce_r
(SK_ai_ipsec, SK_ar_ipsec, SK_ei_ipsec, SK_er_ipsec) = gen_ipsec_secret_key(ipsec_nonce_i, ipsec_nonce_r)
...
(ipsec_spi_i, ipsec_nonce_i) 	= gen_create_child__sa_for_rekey_ipsec(ipsec_spi_i, SK_ei, SK_ai)
while True:
...
del_ipsec_sa(ike_spi_i_ori, ike_spi_r_ori, ipsec_spi_i_ori, SK_ai, SK_ei)
...
time.sleep(15)
del_ipsec_sa(ike_spi_i_ori, ike_spi_r_ori, ipsec_spi_i, SK_ai, SK_ei)
time.sleep(1)


(ike_spi_i, ike_nonce_i) 	= gen_create_child_sa_for_rekey_ike(ya, ike_spi_i, ike_spi_r, SK_ai, SK_ei)
while True:
    ike_create_child_sa_response = s.recv()
    if ike_create_child_sa_response is None or ike_create_child_sa_response[Ether].src == src_mac:
        continue  
