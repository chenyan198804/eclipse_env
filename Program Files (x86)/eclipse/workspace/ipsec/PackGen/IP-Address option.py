...
'''
test_pppoe_server_send_ip_compression_protocol_option = True
test_pppoe_server_send_nak_0_0_0_0_ip_address = False
test_pppoe_server_send_nak_with_illegal_ip_address = False		#WBTS_TRS_13721 invalid local ip
test_pppoe_server_send_request_with_illegal_ip_address = False	#WBTS_TRS_13726 invalid remote ip
test_pppoe_server_reject_0_0_0_0_ip_address = False
test_pppoe_server_send_null_ip_option = False
	...
	#			ppp_lcp_reply.show2()
			...
			if ppp[PPP_IPCP].code in [1]:				#ppp ipcp request
				...
				if send_ipcp_request_flag:
					...
					if test_pppoe_server_send_ip_compression_protocol_option:
						ppp_ipcp_request[PPP_IPCP].options = PPP_IPCP_Option_IPAddress(data="10.0.0.1")/"\x02\x04\x00\x2d\x03\x01"
						test_pppoe_server_send_ip_compression_protocol_option = False
					if test_pppoe_server_send_null_ip_option:
						ppp_ipcp_request[PPP_IPCP].options = ''
					if test_pppoe_server_send_request_with_illegal_ip_address:
						# ppp_ipcp_request[PPP_IPCP].options = PPP_IPCP_Option_IPAddress(data="127.0.0.1")
						# ppp_ipcp_request[PPP_IPCP].options = PPP_IPCP_Option_IPAddress(data="224.0.0.2")
						# ppp_ipcp_request[PPP_IPCP].options = PPP_IPCP_Option_IPAddress(data="240.255.255.255")
						ppp_ipcp_request[PPP_IPCP].options = PPP_IPCP_Option_IPAddress(data="255.255.255.255")
				...
				for ipcp_option in ppp[PPP_IPCP].options:
					if type(ipcp_option) is PPP_IPCP_Option_IPAddress:
						...
						if ipcp_option.data == "0.0.0.0":
							...
							if test_pppoe_server_send_nak_0_0_0_0_ip_address:
								ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "0.0.0.0"
							if test_pppoe_server_send_nak_with_illegal_ip_address:
								ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "127.0.0.1"	#127.0.0.1 is a legal IP address based on requirement
								# ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "224.0.0.2"
								# ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "240.255.255.255"
								# ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "255.255.255.255"
							if test_pppoe_server_reject_0_0_0_0_ip_address:
								ppp_ipcp_reply[PPP_IPCP].code = 0x04
								ppp_ipcp_reply[PPP_IPCP_Option_IPAddress].data = "0.0.0.0"
